...
extension UIView {
    func maskFrom(_ fromRect:CGRect,duration:TimeInterval ,complete:@escaping ()->() = {}){
        ...
        let fromPath = UIBezierPath(arcCenter: fromCenter, radius: fromRadius, startAngle: 0, endAngle: CGFloat.pi * 2, clockwise: true)
        ...
        let toPath = UIBezierPath(arcCenter: fromCenter, radius: toRadius, startAngle: 0, endAngle: CGFloat.pi * 2, clockwise: true)
    ...
    func maskTo(_ toRect:CGRect,duration:TimeInterval ,complete:@escaping ()->() = {}){
        ...
        let toPath = UIBezierPath(arcCenter: toCenter, radius: toRadius, startAngle: 0, endAngle: CGFloat.pi * 2, clockwise: true)
        ...
        let fromPath = UIBezierPath(arcCenter: toCenter, radius: fromRadius, startAngle: 0, endAngle: CGFloat.pi * 2, clockwise: true)
